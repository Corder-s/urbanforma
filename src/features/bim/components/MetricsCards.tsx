...
import { Box, Building2, Layers, Mountain, Ruler, TreePine, Waves, AlertTriangle } from "lucide-react";
 ...
 */
export function MetricsCards({ quantities, model, openIssues, compact = false }: MetricsCardsProps) {
  if (!quantities) {
    return (
