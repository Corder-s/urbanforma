...
export const SECTION_CATALOG: SectionMeta[] = [
  ...
  { id: "sitePlan", label: "Site Plan", blurb: "Plan-view figure of the site: boundary, streets, landscape and proposed massing.", needs: ["planning"] },
...
export const REPORT_TYPES: ReportTypeMeta[] = [
  {
    ...
    sections: ["executiveSummary", "modelView", "keyMetrics", "insights", "recommendations"],
  },
  {
    id: "planning",
    label: "Planning Report",
    description: "The proposed plan: site context, programme, urban form and land use.",
    sections: ["projectOverview", "siteContext", "sitePlan", "planningOverview", "urbanForm", "modelView", "keyMetrics"],
  },
  {
    id: "environmental",
    label: "Environmental Report",
    description: "Environmental performance: solar, heat, wind, green, carbon and mobility.",
    sections: ["executiveSummary", "sitePlan", "environmental", "mobility", "insights", "recommendations"],
  },
  {
    id: "optimization",
