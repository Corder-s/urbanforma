...
export const THEMES: ThemeDef[] = [
  {
    ...
    card: "rounded-2xl border border-line bg-white/95 shadow-float",
    title: "text-ink",
    subtitle: "text-muted",
    caption: "text-faint",
    value: "text-ink",
  ...
  },
  {
    ...
    card: "rounded-none border-l-2 border-primary bg-white/70 backdrop-blur-[2px]",
    title: "text-ink",
    subtitle: "text-muted",
    caption: "text-faint",
    value: "text-ink",
  ...
  },
  {
    ...
    card: "rounded-2xl border border-white/10 bg-ink/85 shadow-float",
    title: "text-white",
