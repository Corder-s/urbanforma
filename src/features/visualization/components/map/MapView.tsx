  ...
  return (
    ...
    >
      <svg width={size.width || "100%"} height={size.height || "100%"} className="block" data-map-canvas="true">
        ...
        {view.scale > 0.4 && <rect width="100%" height="100%" fill={`url(#${patternId}-minor)`} />}
      ...
      {/* north arrow */}
      {showNorth && (
      <div className="pointer-events-none absolute left-3 top-3 grid h-11 w-11 place-items-center rounded-xl border border-line bg-white/90 shadow-soft" aria-label="North is up" role="img">
